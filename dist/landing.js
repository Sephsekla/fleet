...
var _jquery = __webpack_require__(/*! jquery */ "./node_modules/.pnpm/registry.npmjs.org/jquery/3.4.1/node_modules/jquery/dist/jquery.js");
...
var ui = function () {
    ...
    _createClass(ui, null, [{
        ...
        value: function setShieldBar(percent) {
            (0, _jquery2.default)('#shields span').css('width', percent + '%');
        }
    }, {
        key: 'setHullBar',
        value: function setHullBar(percent) {
            (0, _jquery2.default)('#hull span').css('width', percent + '%');
        }
    }, {
        key: 'setEngineBar',
        value: function setEngineBar(percent) {
            (0, _jquery2.default)('#engines span').css('width', percent + '%');
        }
    }]);
